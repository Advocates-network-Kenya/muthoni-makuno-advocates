                        ...
                        <form action="" method="POST">
                            ...
                            <div class="row">
                                ...
                                <div class="col-12 mb-4">
                                    <textarea name="message" class="form-control" placeholder="Brief description of your legal matter..." required></textarea>
                                    @error('message')
                                        <span class="text-danger">{{ $message }}</span>
                                    @enderror
                                </div>
